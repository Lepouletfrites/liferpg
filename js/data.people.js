  ...
  D.NPCS = [
...

    {
      ...
      favors: [
        ...
        { id: 'spot', n: 'Obtenir son emplacement', aff: 55, d: 'La manche rapporte +25 % définitivement', run: function (G) { G.flag('begBoost', true); return 'Marcel vous cède son emplacement devant la boulangerie. C’est un héritage.'; } },
        { id: 'net', n: 'Le réseau des anciens', aff: 75, d: 'Réputation de rue +25 et sommeil dehors amélioré', run: function (G) { G.rep('rue', 25); G.flag('streetNet', true); return 'Il vous présente à six personnes en une soirée. Vous ne dormirez plus jamais vraiment seul.'; } }
      ],
      quest: {
...

    {
      ...
      favors: [
        { id: 'basics', n: 'Apprendre les bases', aff: 20, d: '+120 XP Intelligence', run: function (G) { G.xp('intelligence', 120); return 'Trois heures de cours magistral sur un banc. Vous notez sur un prospectus.'; } },
        { id: 'bankintro', n: 'Une lettre de recommandation', aff: 40, d: 'Score bancaire +25', run: function (G) { G.bankScore(25); return 'Il écrit une lettre à un ancien collègue. Votre dossier bancaire n’est plus vide.'; } },
        { id: 'reader', n: 'Apprendre à lire le marché', aff: 60, d: 'Les tendances de la bourse deviennent visibles', run: function (G) { G.flag('marketRead', true); return 'Il vous apprend à lire ce que les autres ne regardent pas. Vous verrez désormais la tendance de chaque actif.'; } },
        { id: 'seedadvice', n: 'Le conseil de trop', aff: 80, d: 'Rendements boursiers durablement améliorés', run: function (G) { G.flag('lucienEdge', true); return '« Ne me remerciez pas. Faites juste mieux que moi. » Vos arbitrages seront désormais plus fins.'; } }
      ]
    },

    {
      ...
      favors: [
        { id: 'eyes', n: 'Se faire des yeux', aff: 25, d: '+10 discrétion en repérage : les coups réussissent mieux', run: function (G) { G.flag('lookout', true); G.xp('discretion', 40); return 'Elle et ses amis vous préviendront des patrouilles. Vos coups gagnent en marge.'; } },
        { id: 'net', n: 'Le réseau des jeunes', aff: 45, d: 'Réputation de rue +18', run: function (G) { G.rep('rue', 18); return 'En une semaine, tout le quartier sait qui vous êtes. En bien.'; } },
        { id: 'save', n: 'La sortir de la rue', aff: 70, d: 'Coûte 2 000 € · moral +40 définitif', run: function (G) { if (G.money() < 2000) return null; G.cash(-2000, 'Caution pour Yasmine'); G.add('moral', 40); G.flag('yasmineSaved', true); G.rep('legale', 10); return 'Vous payez la caution d’un studio et six mois d’avance. Elle pleure, puis elle vous engueule, puis elle part.'; } }
      ],
      quest: {
...

    {
      ...
      favors: [
        { id: 'scale', n: 'Négocier la balance', aff: 20, d: 'Le vol de métal rapporte +30 %', run: function (G) { G.flag('scrapBoost', true); return 'La balance penche enfin de votre côté. Officiellement, elle a été réétalonnée.'; } },
        { id: 'tools', n: 'Récupérer des outils', aff: 35, d: 'Reçoit une caisse à outils', run: function (G) { G.give('outils', 1); return 'Il sort une caisse d’un container. « Elle a servi. Elle servira encore. »'; } },
        { id: 'fence', n: 'Devenir son intermédiaire', aff: 55, d: 'Débloque le recel · réputation pègre +15', run: function (G) { G.rep('pegre', 15); G.flag('fenceOk', true); return 'Il vous présente à ceux qui achètent. Vous n’êtes plus seulement celui qui apporte.'; } }
      ]
    },
...

    {
      ...
      favors: [
        ...
        { id: 'papers', n: 'Refaire ses papiers', aff: 60, d: 'Réputation légale +20', run: function (G) { G.rep('legale', 20); G.flag('nopapers', false); return 'Elle vous accompagne à la préfecture. Vous existez de nouveau administrativement.'; } },
        { id: 'job', n: 'Une insertion professionnelle', aff: 78, d: 'Embauche directe comme agent d’entretien', run: function (G) { G.hire('cleaner', true); G.rep('legale', 10); return 'Un contrat aidé, six mois, renouvelable. Elle a bataillé trois semaines pour ça.'; } }
      ],
      quest: {
...

    {
      ...
      favors: [
        ...
        { id: 'record', n: 'Faire effacer une mention', aff: 75, d: 'Casier judiciaire allégé de 2 points', run: function (G) { G.clearCasier(2); return 'Une procédure d’effacement anticipé, appuyée par un rapport favorable. Deux lignes disparaissent.'; } }
      ]
    },
...

    {
      ...
      lock: { repLeg: 12 },
      favors: [
        { id: 'open', n: 'Faire ouvrir un compte', aff: 15, d: 'Ouvre un compte bancaire sans condition', run: function (G) { G.openBank(true); return 'Elle remplit le dossier elle-même et signe à votre place aux endroits sans importance.'; } },
        { id: 'score', n: 'Faire relever votre note', aff: 40, d: 'Score bancaire +30', run: function (G) { G.bankScore(30); return 'Elle reclasse votre dossier en catégorie « revenus irréguliers mais fiables ». C’est un monde de différence.'; } },
        { id: 'rate', n: 'Négocier le taux', aff: 60, d: 'Taux des crédits réduit de moitié, définitivement', run: function (G) { G.flag('goodRate', true); return 'Votre prochain crédit sera au taux réservé aux gens qui n’en ont pas besoin.'; } },
        { id: 'blind', n: 'Un virement sans traçabilité', aff: 85, d: 'Blanchit 20 000 € d’argent sale immédiatement', run: function (G) { var d = Math.min(20000, G.dirtyVal()); if (d < 500) return null; G.launderRaw(d, 0.05); return 'Elle regarde ailleurs pendant trois minutes. ' + G.eur(Math.round(d * 0.95)) + ' arrivent sur votre compte, propres.'; } }
      ]
    },
...

    {
      ...
      lock: { repLeg: 18 },
      favors: [
        { id: 'nodeposit', n: 'Louer sans caution', aff: 30, d: 'Toutes les cautions de logement sont annulées', run: function (G) { G.flag('noDeposit', true); return '« Je te fais confiance. Ne m’oblige pas à regretter. » Plus aucune caution à avancer.'; } },
        { id: 'cheap', n: 'Obtenir un loyer d’ami', aff: 55, d: 'Loyers réduits de 30 % définitivement', run: function (G) { G.flag('rentCut', true); return 'Elle rature le bail et réécrit le montant à la main.'; } },
        { id: 'sell', n: 'Racheter un immeuble', aff: 80, d: '80 000 € · société immobilière offerte au niveau 3', run: function (G) { if (G.money() < 80000) return null; G.cash(-80000, 'Achat d’immeuble'); G.grantBiz('realestate', 3); return 'Elle vous vend le petit immeuble de la rue Basse, bien en dessous du marché. « Occupe-toi des locataires. »'; } }
      ]
    },

    {
      ...
      favors: [
        ...
        { id: 'seriesa', n: 'Tour de table majeur', aff: 85, d: 'Reçoit 150 000 € · réputation légale +15', run: function (G) { G.cash(150000, 'Tour de table'); G.rep('legale', 15); return 'Quatre investisseurs, une salle de réunion, quarante minutes. Cent cinquante mille.'; } }
      ],
      quest: {
...

    {
      ...
      favors: [
        { id: 'job', n: 'Accepter une course', aff: 20, d: '150–400 € · pression policière +25', risky: true, run: function (G) { var g = G.rnd(150, 400); G.dirtyCash(g, 'Course pour Karim'); G.heat(25); G.rep('rue', 8); G.rep('pegre', 6); G.rep('legale', -6); return 'Un colis d’un point A à un point B. Vous ne demandez pas ce qu’il y a dedans. ' + G.eur(g) + ' d’argent sale.'; } },
        { id: 'stock', n: 'Obtenir du stock à crédit', aff: 35, d: 'Reçoit 2 lots de marchandise à écouler', run: function (G) { G.give('came', 2); G.flag('karimStock', G.day() + 10); return 'Deux lots, à écouler en dix jours. « Après, c’est plus moi qui viens te voir. »'; } },
        { id: 'clean', n: 'Faire nettoyer son dossier', aff: 45, d: 'Pression policière remise à 0 · 300 €', run: function (G) { if (G.money() < 300) return null; G.cash(-300, 'Arrangement'); G.setHeat(0); return 'Un dossier disparaît. On ne vous explique pas comment.'; } },
        { id: 'cash', n: 'Emprunter du capital', aff: 60, d: 'Reçoit 3 000 € · 4 500 € à rendre sous 12 jours', run: function (G) { G.cash(3000, 'Prêt de Karim'); G.flag('debt', 4500); return 'Trois mille en liquide. « Tu me rends quatre mille cinq. Pas de retard. »'; } },
        { id: 'intro', n: 'Être présenté au Grec', aff: 75, d: 'Débloque le parrain · réputation pègre +20', run: function (G) { G.rep('pegre', 20); G.flag('grecOk', true); G.aff('legrec', 10); return 'Il passe un appel de trente secondes. « Il te reçoit jeudi. Sois à l’heure et ne parle pas le premier. »'; } }
      ]
    },

    {
      ...
      lock: { repPegre: 15 },
      favors: [
        { id: 'spar', n: 'S’entraîner avec lui', aff: 20, d: '+150 XP Force', run: function (G) { G.xp('force', 150); G.add('sante', -6); return 'Deux heures dans une cave. Vous ne gagnez pas une seule fois. Vous progressez énormément.'; } },
        { id: 'gun', n: 'Obtenir une arme', aff: 45, d: 'Reçoit une arme de poing', run: function (G) { G.give('arme', 1); return 'Il la pose sur la table, chargeur retiré. « Si tu la sors, c’est que t’as déjà perdu. »'; } },
        { id: 'crew', n: 'L’avoir sur les coups', aff: 55, d: 'Améliore durablement les braquages', run: function (G) { G.flag('crewBruno', true); return 'Il sera là. C’est tout ce qu’il dit, et c’est suffisant.'; } },
        { id: 'debt', n: 'Faire annuler une dette', aff: 70, d: 'Efface toutes vos dettes de rue', run: function (G) { G.clearStreetDebt(); return 'Il rend visite à deux personnes. Le lendemain, plus personne ne vous réclame rien.'; } }
      ]
    },

    {
      ...
      lock: { repPegre: 20 },
      favors: [
        { id: 'lesson', n: 'Prendre une leçon', aff: 20, d: '+160 XP Discrétion', run: function (G) { G.xp('discretion', 160); return 'Elle vous fait crocheter la même serrure quarante fois. À la quarantième, vous mettez huit secondes.'; } },
        { id: 'kit', n: 'Obtenir son matériel', aff: 40, d: 'Reçoit crochets, gants et brouilleur', run: function (G) { G.give('crochets', 1); G.give('gants', 1); G.give('brouilleur', 1); return 'Un sac de sport entier. « C’est du vieux. Mais du vieux qui marche. »'; } },
        { id: 'crew', n: 'L’avoir sur les coups', aff: 55, d: 'Améliore durablement les cambriolages', run: function (G) { G.flag('crewNadia', true); return 'Elle accepte à une condition : elle choisit les cibles. Vous acceptez.'; } },
        { id: 'ghost', n: 'Apprendre à disparaître', aff: 80, d: 'La pression policière retombe deux fois plus vite', run: function (G) { G.flag('ghost', true); return 'Habitudes, itinéraires, téléphones, visage. Elle vous apprend à ne plus laisser de forme.'; } }
      ]
    },

    {
      ...
      lock: { flag: 'grecOk' },
      favors: [
        { id: 'blessing', n: 'Obtenir sa bénédiction', aff: 30, d: 'Réputation pègre +30 · tous les coups réussissent mieux', run: function (G) { G.rep('pegre', 30); G.flag('blessed', true); return 'Il pose la main sur votre épaule devant six personnes. C’est une signature.'; } },
        { id: 'territory', n: 'Obtenir un territoire', aff: 55, d: 'Offre le réseau de distribution (niveau 2)', run: function (G) { G.grantBiz('cartel', 2); return 'Trois rues, quinze points, quarante guetteurs. « Ne me fais pas regretter ce jeudi. »'; } },
        { id: 'immunity', n: 'La protection totale', aff: 85, d: 'Les arrestations mineures n’ont plus lieu', run: function (G) { G.flag('protected', true); return 'Il ne dit rien. Trois semaines plus tard, un commissaire est muté. Vous comprenez seul.'; } }
      ],
      quest: {
